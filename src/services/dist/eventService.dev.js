...
function () {
  ...
  _createClass(EventService, null, [{
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return regeneratorRuntime.awrap(_supabaseClient.supabase.from('Events').select('*').order('created_at', {
                ascending: false
              }));
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 3;
                        return regeneratorRuntime.awrap(_supabaseClient.supabase.from('Profiles').select('id, full_name, email').eq('id', event.host_id).single());
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 8:
              ...
              _context3.next = 12;
              return regeneratorRuntime.awrap(_supabaseClient.supabase.from('Profiles').select('id, full_name, email').eq('id', data.host_id).single());
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              console.log('related_interests type:', _typeof(eventData.related_interests));
            ...
            case 18:
              ...
              console.error('EventService.createEvent error:', _context4.t0);
              return _context4.abrupt("return", {
                data: null,
                error: _context4.t0
              });
                  ...
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        ...
                        _context9.next = 3;
                        return regeneratorRuntime.awrap(_supabaseClient.supabase.from('Profiles').select('id, full_name, email').eq('id', rsvp.user_id).single());
        ...
        while (1) {
          switch (_context14.prev = _context14.next) {
            case 0:
              ...
              _context14.next = 4;
              return regeneratorRuntime.awrap(_supabaseClient.supabase.from('Events').select('*').or("title.ilike.%".concat(searchTerm, "%,description.ilike.%").concat(searchTerm, "%")).order('created_at', {
                ascending: false
              }));
    ...
    key: "getEventsByUser",
    value: function getEventsByUser(userId) {
      var _ref18, data, error, eventsWithUsers;

      return regeneratorRuntime.async(function getEventsByUser$(_context18) {
        while (1) {
          switch (_context18.prev = _context18.next) {
            case 0:
              _context18.prev = 0;
              _context18.next = 3;
              return regeneratorRuntime.awrap(_supabaseClient.supabase.from('Events').select('*').eq('host_id', userId) // Filter by host_id to get events created by this user
              .order('created_at', {
                ascending: false
              }));
    ...
    value: function getUpcomingEvents() {
      var _ref20, data, error, eventsWithUsers;

      return regeneratorRuntime.async(function getUpcomingEvents$(_context20) {
        while (1) {
          switch (_context20.prev = _context20.next) {
            ...
            case 8:
              ...
              _context20.next = 11;
              return regeneratorRuntime.awrap(Promise.all(data.map(function _callee7(event) {
                var _ref21, userData;
                  ...
                  while (1) {
                    switch (_context19.prev = _context19.next) {
                      ...
                      case 3:
                        ...
                        userData = _ref21.data;
                        return _context19.abrupt("return", _objectSpread({}, event, {
                          users: userData || null
                        }));

                      case 6:
                        return _context19.abrupt("return", event);
            ...
            case 11:
              eventsWithUsers = _context20.sent;
