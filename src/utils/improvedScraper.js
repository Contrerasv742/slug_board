  ...
  eventbrite: [
    {
      ...
      description:
        "Join us for an evening of networking and tech talks in beautiful Santa Cruz!",
    ...
    },
    {
      ...
      description:
        "Experience local artists and their latest works in our monthly gallery opening.",
  ...
  meetup: [
    {
      ...
      description:
        "Join our hiking club for a beautiful coastal trail walk with stunning ocean views.",
    ...
    },
    {
      ...
      description:
        "Learn photography techniques from professional photographers in scenic locations.",
  ...
  santacruz: [
    {
      ...
      description:
        "Live music at the historic Santa Cruz Beach Boardwalk with local bands.",
    ...
    },
    {
      ...
      description:
        "Fresh local produce, artisanal foods, and live entertainment every Wednesday.",
  ...
  generic: [
    {
      ...
      description:
        "Join our community for a relaxing yoga session in the park.",
  ...
  try {
    ...
    try {
      ...
      if (!error && existingEvents && existingEvents.length > 0) {
        console.log(
          `✅ Found ${existingEvents.length} existing events from database`,
        );
...
function detectPlatform(url) {
  ...
  if (urlLower.includes("santacruz") || urlLower.includes("cityofsantacruz"))
    return "santacruz";
...
function formatEventsForApp(events) {
  return events.map((event) => ({
    ...
    endDateTime:
      event.end_time || addHoursToDate(event.date || event.start_time, 2),
...
function isEventFree(priceString) {
  ...
  return (
    priceString.toLowerCase().includes("free") || priceString.includes("$0")
  );
}
...
function determineCategory(title, description) {
  ...
  if (text.includes("business") || text.includes("networking"))
    return "Business";
  if (text.includes("fitness") || text.includes("yoga"))
