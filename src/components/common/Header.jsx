...
const Header = ({
  ...
  return (
    <header
      className="bg-global-1 border-b-2 border-white border-opacity-60
    ...
    >
      ...
      >
        ...
        >
          ...
          <h1
            className="text-global-4 font-ropa text-lg sm:text-xl
        ...
        >
          <div className="profile-border-animated">
            <div
              className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-global-4
